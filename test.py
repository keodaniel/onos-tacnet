...
#     datestring = datetime.datetime.now().strftime("%Y-%m-%d-%H%M")
#     filename = f"{datestring} {testcase}-{topo}-t{iperf_time}-P{parallel_connections}-{trial_runs}runs"
#     log_file_path = f'logs/{filename}.log'
